...
public:
    ...
    void InitializeBackProjectionBuffers(int im_width, int im_height);
...
inline void Write3DPointToFile(const std::string& fname, const std::vector<cv::Vec3d>& points3d) {
