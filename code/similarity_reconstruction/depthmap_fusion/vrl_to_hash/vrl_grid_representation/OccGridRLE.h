...
class OccGridRLE {
 ...
 public:
    ...
    // OccElementColor *getScanline(int y, int z, OccElementColor *line = NULL);
	...
	void putNextElement(OccElement *element);
    // void putNextElement(OccElementColor *element);
	void putNextLength(RunLength length);
	OccElement *getNextElement();
	RunLength getNextLength();
...
#ifdef OCCELEM_COLOR
    newElem->color = element->color;
#endif
}

//inline void
//OccGridRLE::putNextElement(OccElementColor *element)
//{
//    OccElementColor *newElem =
//        (OccElementColor *)this->elementChunker->alloc(sizeof(OccElementColor));
//    newElem->value = element->value;
//    newElem->totalWeight = element->totalWeight;
//    newElem->color = element->color;
//}
