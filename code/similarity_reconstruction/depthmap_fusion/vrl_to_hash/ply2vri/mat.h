...
Mat4<T> operator * ( const Mat4<T>& a, const Mat4<T>& b );
template <class T>
Mat4<T> operator * ( const Mat4<T>& a, const double d );
template <class T>
Mat4<T> operator * ( const double d, const Mat4<T>& a );
template <class T>
Vec3<T> operator * ( const Mat4<T>& a, const Vec3<T>& b );
template <class T>
Mat4<T> operator / ( const Mat4<T>& a, const double d );
template <class T>
...
template <class T>
istream& operator >> ( istream& is, Mat4<T>& m );
//==========[ class Mat3 ]=====================================================
...
//				throw SingularMatrixException();
	...
	friend istream& operator >>( istream& is, Mat3<T>& m );
#else
	friend Mat3<T> operator - <>( const Mat3<T>& a );
	friend Mat3<T> operator + <>( const Mat3<T>& a, const Mat3<T>& b );
	friend Mat3<T> operator - <>( const Mat3<T>& a, const Mat3<T>& b );
...
//				throw SingularMatrixException();
	...
	friend istream& operator >>( istream& is, Mat4<T>& m );
#else
	friend Mat4<T> operator - <>( const Mat4<T>& a );
	friend Mat4<T> operator + <>( const Mat4<T>& a, const Mat4<T>& b );
	friend Mat4<T> operator - <>( const Mat4<T>& a, const Mat4<T>& b );
