...
run_root=$result_root/seperate-seq-batch-buildingseq3/
if [ ! -d $run_root ]; then
    mkdir $run_root
fi
...
train_detect_delta_rot=7.5 # degree

detect_delta_x=1
detect_delta_y=1
detect_delta_rot=7.5
...
#
    ...
    joint_learn_output_root=$batch_output_root/joint_learn-try2-$seq_i-merge_score_thresh-$merge_score_thresh-noisecounter-float-$noise_counter_thresh-noisecompo-$noise_comp_thresh-neighbor1-denoise-recon-multiter-nofinalsingleclean-0thsamplescalefixed2
