...
detect_output_file=/home/dell/link_to_results/svm_test_t1_debug_detect_dx-0.5_dy-0.5_dr-15_linear_nonnoisy/house_1_SlidingBoxDetectionResults_Parallel_Final.txt
detect_output_file=/home/dell/link_to_results/svm_test_newmerge_t1_debug_detect_dx-0.5_dy-0.5_dr-15_linear_nonnoisy_nojitter/house_1_SlidingBoxDetectionResults_Parallel_Final.txt
trynum=15
...
detect_output_file=$output_prefix/house_1_SlidingBoxDetectionResults_Parallel_Final.txt
# input svm model
...
#input_NMS_file=""
#input_NMS_file=/home/dell/link_to_results/PRCurve_test_1890-2090-nonnoisy_debug_detect_svm_2_dx-0.5_dy-0.5_dr-15_linear_bug2-nojittering/house_1NMS_res.txt
...
vy=9
vz=6
output_prefix=/home/dell/codebase/mpi_project/urban_reconstruction/code/build/hashmap/results/PRCurve_test_1890-2090-nonnoisy_debug_detect_$trynum-svm_2_dx-0.5_dy-0.5_dr-15_linear_bug2-nojitter
...
echo $test_bin $input_samples --out-dir-prefix $output_prefix --save_tsdf_bin --mesh-min-weight 0.0  --detect_output_file $detect_output_file --sample_voxel_sidelengths $vx $vy $vz --detected-obb-file $detected_obb_file --input_nms_file $input_NMS_file
$test_bin $input_samples --out-dir-prefix $output_prefix --save_tsdf_bin --mesh-min-weight 0.0  --detect_output_file $detect_output_file --sample_voxel_sidelengths $vx $vy $vz --detected-obb-file $detected_obb_file #--input_nms_file $input_NMS_file
