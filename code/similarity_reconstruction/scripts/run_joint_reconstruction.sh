...
detection_root=$result_root/refactor_detection_final1_replaced_adjusted_atfinal/
run_root=$result_root/refactor_joint_reconstruction_5_clean_validw/
run_root=$result_root/refactor_jointrecon_final1_replaced_adjusted_atfinal3/
#run_root=$result_root/refactor_detection_final1_replaced/
if [ ! -d $run_root ]; then
    mkdir $run_root
fi
mesh_min_weight=0
