...
data_root=/home/dell/Data/data_1/
cam_root=$data_root/2013_05_28_drive_0000_sync/image_03/rect/
...
input_tsdf_file=/home/dell/link_to_results/output-3d-model-camera2-test1/ply-0-200-1.0-newtest-conf-flatten-0-noclean-voxellen-0.2-maxdist-1.6_bin_tsdf_file.bin
# parameters
startimg=0
endimg=200
param_prefix=param2
...
output_dir=$output_root"output-3d-model-camera3-test-withcam2-no-satarate/"
...
echo $recon_bin --in-root $cam_root --out $outputfile_conf".ply" --save-ascii --startimage $startimg --endimage $endimg --flatten --min_weight $weight --diffusion-smooth --niteration $niteration --use_confidence --truncation_limit $maxdist --voxel_length $voxellen --do_fuse --param-prefix $param_prefix --image-prefix $image_prefix --depth-prefix $depth_prefix --input-tsdf-filepath $input_tsdf_file
$recon_bin --in-root $cam_root --out $outputfile_conf".ply" --save-ascii --startimage $startimg --endimage $endimg --flatten --min_weight $weight --diffusion-smooth --niteration $niteration --use_confidence --truncation_limit $maxdist --voxel_length $voxellen --do_fuse --param-prefix $param_prefix --image-prefix $image_prefix --depth-prefix $depth_prefix --input-tsdf-filepath $input_tsdf_file
