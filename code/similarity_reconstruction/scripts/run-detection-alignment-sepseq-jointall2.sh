...
#run_root=$result_root/seperate-seq-batch-all-seq0-detector-building2-car-try2/
run_root=$result_root/seperate-seq-batch-all-seq3-detector-building-car-try2/
run_root=$result_root/seperate-seq-batch-all-seq5-detector-building-car-try2/
...
merge_score_thresh_arr=(0.3 0.5)
do_train_detector_arr=(0 0)
do_detection_arr=(0 0)
do_NMS_arr=(0 0)
do_pr_arr=(0 0)
do_adjust_obbs_arr=(0 0)
do_merge_tsdf_obb_arr=(0 0)

do_init_consistent_check_arr=(0 1)
do_init_skymap=(0 1)
init_depth_check_arr=(0 1)

do_final_merge=1
do_final_joint_carbuildinglearn=1
do_joint_learn_arr=(1 1 $do_final_joint_carbuildinglearn)
do_consistency_check_arr=(1 1)
...
#
    ...
    echo "#################   prepare joint learn dirs #############"
    joint_learn_suffix=$seq_i-merge_score_thresh-$merge_score_thresh-noisecounter-float-$noise_counter_thresh-noisecompo-$noise_comp_thresh-iter-3-looser-consist_check3-try2-testrpca
...
echo in_models_merge $in_models_merge
out_dir=$batch_output_root/multi_cate_merged/
if [ ! -d $out_dir ]; then
    mkdir $out_dir
fi
