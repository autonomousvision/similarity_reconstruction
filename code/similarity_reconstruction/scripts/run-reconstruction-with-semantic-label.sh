...
outputdir=$output_root"output-3d-model-semantic/"
mkdir $outputdir
set -e
...
$recon_bin --in-root /ps/geiger/czhou/2013_05_28/2013_05_28_drive_0000_sync/image_02/rect/ --out $outputfile_conf".ply" --depth-prefix $depth_pref --save-ascii --startimage $startimg --endimage $endimg --flatten --min_weight $weight --diffusion-smooth --niteration $niteration --tsdf-filepath $outputfile_conf_tsdfbin"_bin_tsdf_file.bin" --use_confidence --use_semantic $semantic_pref
done
done
