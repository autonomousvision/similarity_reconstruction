...
run_root=$result_root/seperate-seq-batch-all-seq2-detector-building2-car-try3-rebut/
...
lowest_score_to_supress_arr=(-1.0 -0.5 -0.50)
noise_counter_thresh_arr=(3 1 3)
...
merge_score_thresh_arr=(-0.2 0.3 0.5)
do_train_detector_arr=(0 0 0)
do_detection_arr=(0 0 0)
do_NMS_arr=(0 0 0)
do_pr_arr=(0 0 0)
do_adjust_obbs_arr=(0 0 0)
do_merge_tsdf_obb_arr=(0 0 0)

do_init_consistent_check_arr=(0 0 1)
#do_init_skymap=(0 0 0)
#init_depth_check_arr=(0 0 0)
do_init_skymap=(0 0 1)
init_depth_check_arr=(0 0 1)

do_final_merge=1
do_final_joint_carbuildinglearn=1
do_joint_learn_arr=(0 0 1 $do_final_joint_carbuildinglearn)
pca_num_arr=(0 0 0)
do_consistency_check_arr=(0 0 1)
