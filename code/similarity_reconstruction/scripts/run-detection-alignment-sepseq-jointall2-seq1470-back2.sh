...
run_root=$result_root/seperate-seq-batch-all-seq0-detector-building2-car-try2-rebut/
...
merge_score_thresh_arr=(0.01 0.01 1)
do_train_detector_arr=(1 1 0)
do_detection_arr=(1 1 0)
do_NMS_arr=(1 1 0)
do_pr_arr=(1 1 0)
do_adjust_obbs_arr=(1 1 0)
do_merge_tsdf_obb_arr=(1 1 0)

do_init_consistent_check_arr=(1 1 0)
do_init_skymap=(0 0 0)
init_depth_check_arr=(0 0 0)

do_final_merge=1
do_final_joint_carbuildinglearn=1
do_joint_learn_arr=(0 0 0 $do_final_joint_carbuildinglearn)
...
##
    ...
    joint_learn_suffix=$seq_i-merge_score_thresh-$merge_score_thresh-noisecounter-float-$noise_counter_thresh-noisecompo-$noise_comp_thresh-iter-3-looser-consist_check3
