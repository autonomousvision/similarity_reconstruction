// vec.h
//
// Handy vector classes (modified for use with ply2vri).
// by Charles Gordon and Brett Allen
//
...
template<typename T>
T operator * ( const Vec3<T>& a, const Vec4<T>& b );
template<typename T>
T operator * ( const Vec4<T>& b, const Vec3<T>& a );
template<typename T>
Vec3<T> operator * ( const Vec3<T>& a, const double d );
template<typename T>
Vec3<T> operator * ( const double d, const Vec3<T>& a );
template<typename T>
...
template<typename T>
Vec3<T> minimum( const Vec3<T>& a, const Vec3<T>& b );
template<typename T>
Vec3<T> maximum( const Vec3<T>& a, const Vec3<T>& b );
template<typename T>
...
template <class T>
Vec4<T> operator * ( const Vec4<T>& a, const double d );
template <class T>
Vec4<T> operator * ( const double d, const Vec4<T>& a );
template <class T>
...
template <class T>
istream& operator >> ( istream& is, Vec4<T>& v );
template <class T>
Vec4<T> minimum ( const Vec4<T>& a, const Vec4<T>& b );
template <class T>
Vec4<T> maximum ( const Vec4<T>& a, const Vec4<T>& b );
template <class T>
