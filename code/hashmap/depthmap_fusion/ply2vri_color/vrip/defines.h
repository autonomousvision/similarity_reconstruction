...
#ifndef SWAP_INT
#define SWAP_INT(a, b) _temp_int = (a); (a) = (b); (b) = _temp_int
#endif

#ifndef SWAP_FLOAT
#define SWAP_FLOAT(a, b) _temp_float = (a); (a) = (b); (b) = _temp_float
#endif

#ifndef SWAP_USHORT
#define SWAP_USHORT(a, b) _temp_ushort = (a); (a) = (b); (b) = _temp_ushort
#endif
